...
### スーパーリアル麻雀PII\&PIII
* 暗槓すると必ず次で相手が5つ目の牌を切る([@kani7/2054374240628199457](https://x.com/kani7/status/2054374240628199457))
...
### 魔法大作戦
* [X68000版魔法大作戦で2Pプレイを可能にする方法についての覚書｜とあるレトロPCオタ](https://note.com/retoropc_etc/n/n1b4cffe92cfe)
  > 上記変更に加えてMAHOU.X内をバイナリエディタで検索して37 00 09 E9 1Eとなっている2箇所を51 00 09 E9 1Eとすれば
  > F3で2P側のみでスタートしたり、1Pと2Pで同時スタートできたりするようでした。
